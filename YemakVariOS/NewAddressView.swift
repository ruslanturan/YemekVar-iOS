            ...
            //                }
                            ...
                            Button(action: {
                                ...
                                URLSession.shared.dataTask(with: request) { (data, response, error) in
                                    ...
                                    guard let url = URL(string: "https://yemekvar.az/api/user/createaddress") else {
                                        return
                                    }
                                    var request = URLRequest(url: url)
                                    request.httpMethod = "POST"
                                    let body: [String: String] = ["userid": loggedID, "street": street, "name": name, "additional_info": apartment, "Latitude": String(lat), "Longtitude": String(lng)]
